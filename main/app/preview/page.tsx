    ...
    return (
        <div className="min-h-screen bg-gray-100 p-4">
            ...
            <div className="mb-6">
                <button
                    onClick={() => router.push("/")}
                    className="flex items-center space-x-2 text-gray-600 hover:text-gray-800 bg-transparent border-none cursor-pointer p-2 rounded-md hover:bg-gray-200 transition-colors"
                >
                    <ArrowLeft size={20} />
            ...
            <div className="max-w-lg mx-auto">
                ...
                <div className="text-center w-full">
                    <button
                        onClick={() => {
                            if (!preview) {
                                alert("No preview data available to download.");
                                return;
                            }
